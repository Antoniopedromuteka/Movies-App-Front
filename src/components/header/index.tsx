      ...
      <header className="w-full h-[100px] border-b-2">
        <div className="flex gap-6 flex-row justify-between items-center relative pt-8 md:px-32 px-12">
            ...
            <div className="hidden md:flex md:gap-8 md:flex-1 md:justify-end">
                <input className="p-2 outline-none border-yellow-400 border-2 bg-gray-800 text-white  px-4 rounded-3xl" type="search" name="" id="" />
                <button className="p-2 outline-none border-yellow-400 border-2 rounded-3xl text-white bg-gray-800 px-10">Sign In</button>
            </div>
